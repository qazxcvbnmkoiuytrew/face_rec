...
window_w, window_h = 600, 480               # 設定視窗長寬
scale = 0.70                                # 影片高度的比例

Form = QtWidgets.QWidget()
Form.setWindowTitle('Image')
...
def windowResize(self):
    ...
    btn1.setGeometry(155,window_h-45,300,30)  # 設定按鈕位置
    #btn2.setGeometry(155,window_h-45,300,30)
...
def opencv():
    global window_w, window_h, scale, photo, output
